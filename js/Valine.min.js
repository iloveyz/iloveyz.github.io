            ...
            try {
                ...
                t.alert = {
                    show: function(e) {
                        ...
                        if (n.innerHTML = "" + r + (e && e.type && i), d.on("click", d.find(C, ".vcancel"),
                        function(e) {
                            t.alert.hide()
            ...
            B = function(e) {
                ...
                function(t) {
                    ...
                    R = {
					 ...
					 _.comment.focus()
					document.getElementById('veditor').value+= n
                    /* d.attr(_.comment, "placeholder", n),
					//console.log($("#veditor").val(n));
					 */
                })
            };  !
            function() {
